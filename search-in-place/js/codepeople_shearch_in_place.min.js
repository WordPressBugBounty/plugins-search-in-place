...
b+=b.indexOf("?")==-1?"?":"&","lang"in codepeople_search_in_place&&(b+="lang="+codepeople_search_in_place.lang+"&"),g+='<a class="search-in-place-more" href="'+b+"s="+encodeURIComponent(this.search)+'&submit=Search">'+codepeople_search_in_place.more+" &gt;</a>"):g+=codepeople_search_in_place.empty;g+="</div>";if(a)a.html(g).find(".thumbnail img").on("load",function(){var m=h.imgSize(this);e(this).width(m.w).height(m.h).css("visibility","visible")});else y.length&&(y.html(g),y.find(".thumbnail img").css("visibility",
