...
* Improves the Elementor integration mdule.
...
* Offers the ability to pass specific selectors, restricting the search to designated elements on the page when the search box shortcode is configured to search within the current page.

= 1.5.1 =

* Enhances the term suggestion module to provide suggestions directly from both the website and Google.
