...
class Elementor_SearchInPlace_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'autocomplete',
			array(
				'label'       => esc_html__( 'Activate the autocomplete for search in current page', 'search-in-place' ),
				'type'        => Controls_Manager::SWITCHER,
				'label_block' => true,
			)
		);
...
Plugin::instance()->widgets_manager->register( new Elementor_SearchInPlace_Widget() );
